...
@section('content')
    <x-sidebar />
    {{-- <div class="w-full lg:w-7/12 lg:ms-64 xl:mx-auto mt-10 mx-5">
        ...
        <div class="overflow-auto h-screen">
            <div class="mt-9 md:grid-cols-2 gap-4 grid grid-cols-1">
                    ...
                    <div class="card rounded-lg">
                        ...
                        <div class="p-5">
                            <a href="{{ route('blog.critaku.show', $blog->slug) }}">
                                <h5
                                    class="mb-2 text-2xl font-bold tracking-tight capitalize text-indigo-700 hover:underline">
                                    {{ $blog->title }}</h5>
                            </a>
